...
def mostrar_productos():
    limpiar_panel(panel_principal)
    label_ventas = tk.Label(panel_principal,text="Productos")
    label_ventas.pack()

def mostrar_reportes():
    limpiar_panel(panel_principal)
    label_ventas = tk.Label(panel_principal,text="Reportes")
    label_ventas.pack()

def mostrar_usuarios():
    limpiar_panel(panel_principal)
    label_ventas = tk.Label(panel_principal,text="Usuarios")
    label_ventas.pack()
